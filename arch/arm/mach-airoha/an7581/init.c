...
#define AN7581_SCREG_WR1		0x1fb00284
#define AN7581_DRAM_SIZE_SHIFT		20
#define AN7581_DRAM_SIZE_MASK		0x3ff
...
int dram_init(void)
{
	...
	units = (readl(AN7581_SCREG_WR1) >> AN7581_DRAM_SIZE_SHIFT) &
		AN7581_DRAM_SIZE_MASK;
	if (!units)
